 ...
 */
function hydrateIndexPattern(id, savedObject, indexPatterns, config) {
  var clearSavedIndexPattern, indexPattern, index, indexObj;
  return regeneratorRuntime.async(function hydrateIndexPattern$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 10:
          _context.next = 12;
          return regeneratorRuntime.awrap(indexPatterns.get(index));
