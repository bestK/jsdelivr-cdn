...
function SubMetricParamEditor(_ref) {
  ...
  var aggGroup = type === 'customMetric' ? _.AggGroupNames.Metrics : _.AggGroupNames.Buckets;
  (0, _react.useEffect)(function () {
    if (agg.params[type]) {
      setValue(agg.params[type]);
    } else {
      var param = agg.type.paramByName(type);

      if (param) {
        setValue(param.makeAgg(agg));
      }
    }
  }, []);
  ...
  return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_eui.EuiSpacer, {
    ...
    size: "s"
  }), _react.default.createElement(_.DefaultEditorAggParams, {
    agg: agg.params[type],
    groupName: aggGroup,
